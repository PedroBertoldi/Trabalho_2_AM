...
dicionario = dict(max_depth=randint(1,25),n_estimators=randint(10,300))
...
if dicionario != None:
    ...
    modelo = RandomizedSearchCV(train_model,dicionario,n_iter=100,n_jobs=-1)
...
#========================================================================================
        r_model = RandomForestRegressor(max_depth=item["max_depth"],n_estimators=item["n_estimators"],n_jobs=-1)
#========================================================================================
